...
private:
    ...
    void init()
    {
        ...
        sub_tracker_detections = std::make_shared<message_filters::Subscriber<vision_msgs::msg::Detection2DArray>>(this->shared_from_this(), "sky360/tracker/detections");
        ...
        time_synchronizer_ = std::make_shared<message_filters::TimeSynchronizer<sensor_msgs::msg::Image, sky360_interfaces::msg::TrackingState, vision_msgs::msg::Detection2DArray, sky360_interfaces::msg::TrackTrajectoryArray, sky360_interfaces::msg::TrackTrajectoryArray>>(
    ...
    std::shared_ptr<message_filters::Subscriber<vision_msgs::msg::Detection2DArray>> sub_tracker_detections;
    ...
    std::shared_ptr<message_filters::TimeSynchronizer<sensor_msgs::msg::Image, sky360_interfaces::msg::TrackingState, vision_msgs::msg::Detection2DArray, sky360_interfaces::msg::TrackTrajectoryArray, sky360_interfaces::msg::TrackTrajectoryArray>> time_synchronizer_;
